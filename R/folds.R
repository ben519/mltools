...
#' If \code{x} is a positive integer, a vector of FoldIDs of length matching x is returned, otherwise
...
#'
#' @param x A positive integer, a vector of values or a data.table object
...
folds <- function(x, nfolds=5L, stratified=FALSE, seed=NULL){
  ...
  #--------------------------------------------------
  # If x is a vector of length 1 and is a positive integer
